...
import StarGrid from "@/components/StarGird";
  ...
  return (
    <div className="relative" ref={container}>
      ...
      {isFilled.richText(slice.primary.body) && (
        <div className="hero__body mx-auto mb-8 mt-6 max-w-md text-balance text-slate-300 opacity-0">
          <PrismicText field={slice.primary.body} />
        </div>
      )}
      {isFilled.link(slice.primary.button_link) && (
        <div className="hero__button opacity-0">
